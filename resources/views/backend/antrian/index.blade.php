...
@section('styles')
    ...
    <style>
        .queue-display-card {
            ...
            box-shadow: 0 15px 35px -5px rgba(0, 0, 0, 0.06) !important;
            overflow: hidden;
            position: relative;
        }
            ...
            <div class="card control-card h-100 d-flex flex-column justify-content-between">
                <div class="card-header bg-transparent border-bottom py-3">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="bi bi-sliders ms-2 text-primary"></i>لوحة التحكم بالنداء
                    </h5>
                    <p class="text-muted small mb-0 mt-1">إدارة نداء المستفيدين المراجعين للشباك</p>
                </div>
                ...
                <div class="card-footer bg-light border-0 p-3 m-3 rounded-3 text-center">
                    <p class="small text-muted mb-0 lh-base">
                        ...
                        في حال عدم حضور المراجع بعد التكرار 3 مرات، يرجى الانتقال مباشرة للرقم التالي لحفظ انسيابية المواعيد.
                    </p>
                </div>
            </div>
        </div>
