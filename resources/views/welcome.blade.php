...
<body>
    ...
    <footer class="bottom-ticker mt-auto">
        ...
        <marquee direction="right" scrollamount="6">
            أهلاً بكم في جمعية البر بجدة — صالة خدمة المستفيدين — نرجو من مراجعينا الكرام تجهيز الهوية الوطنية والوثائق المطلوبة لسرعة إنهاء الإجراءات — نسعد دائماً بخدمتكم.
        </marquee>
    </footer>
